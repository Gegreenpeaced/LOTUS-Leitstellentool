    ...
    <head>
      ...
      include("meta.php");
       ?>
        ...
        <script type="text/javascript" src="css/jquery-ui-1.8.18.custom.min.js"></script>
        ...
        <main class="app">
            ...
            <nav class="content">
                ...
                <div class="content-main">
                  ...
                  {
                    echo "<div class='info-box-sucess'>";
                      echo "<div class='sucess'>Erfolg! Die Anmeldung wurde erfolgreich deaktiviert und die Anmeldungen gelöscht!</div>";
                    echo "</div>";
                  }
                  if($_GET['msg'] == 7)
                  {
