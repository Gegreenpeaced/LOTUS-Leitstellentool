                  ...
                  <?php
                    ...
                    <table id="sttable">
                        ...
                        <tr>
                          ...
                          if(mysqli_num_rows($res) > 0)
                          {
                            while($dsatz = mysqli_fetch_assoc($res))
                            {
                                ...
                                echo "<td>Not Working at the Moment</td>";                                                                                                         // LATER   <-----   <a class='lstbutton-login-a' href='$dl_center_card'>Umlaufkarte</a>
                        ...
                        <tr>
                          ...
                          <td><input type="text" name="route_number" required='required'></input></td>
                          <?php
                          include("mysql_config.php");
                          $con = mysqli_connect("$MYSQL_HOST", "$MYSQL_USER", "$MYSQL_PASS"); //Datenbank Connection
                          mysqli_select_db($con, "$MYSQL_DB"); //Auswahl der Datenbank
                          ...
                          ?>
                          <td><input type="text" name="route_code" required='required'></input></td>
                          <input type="hidden" name="send" value="1337">
                          <td><input type="text" name="route_card" placeholder='Direkter Download Link'></td>
                            <?php
