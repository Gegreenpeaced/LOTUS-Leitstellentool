...
if($_POST['send'] == 1337)
{
    ...
    if(password_verify($_POST['password'], $dsatz['u_pass']))
    {
        ...
        $_SESSION['theme_url'] = $dsatz['theme_url'];
        $_SESSION['mail'] = $dsatz['u_mail'];
        $_SESSION['username'] = $dsatz['u_nickname'];             // Works fine
        ...
        $sql4 = "UPDATE `sys_user` SET `status` = '1' WHERE `u_nickname` ='" . $_POST['identifier'] . "' OR `u_mail` ='" . $_POST['identifier'] . "'";
