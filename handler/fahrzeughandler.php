...
if($_POST['send'] == 1337)
{
    ...
    $sql = "INSERT INTO `lst_fahrzeuge` (f_nmr, f_class, f_typ, f_stufen, f_zr, f_trak, f_platz, f_gauge) VALUES ('" . $_POST['vehicle_number'] . "','" . $_POST['vehicle_class'] . "','" . $_POST['vehicle_typ'] . "','" . $_POST['vehicle_stairs'] . "','" . $_POST['vehicle_twoway'] . "',
