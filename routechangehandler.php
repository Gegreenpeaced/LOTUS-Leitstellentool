...
if($_POST['send'] == 1337)
{
    ...
    if($num > 0)
    {
      ...
      $sql2 = "INSERT INTO `lst_routes` (r_prim, r_nmr, r_map, r_code, r_dl_cat, r_dest_one, r_dest_two, r_day) VALUES ('" . $_POST['route_prim'] . "', '" . $_POST['route_number'] . "', '" . $_POST['route_map'] . "', '" . $_POST['route_code'] . "','" . $_POST['route_dl_cat'] . "','" . $_POST['route_dest_one'] . "', '" . $_POST['route_dest_two'] . "', '" . $_POST['day'] . "')";
