...
if($_POST['send'] == 1337)
{
        ...
        $prim = uniqid();
        $sql = "INSERT INTO `lst_routes` (r_prim, r_nmr, r_map, r_code, r_dl_cat, r_day) VALUES ('" . $prim . "', '" . $_POST['route_number'] . "', '" . $_POST['route_map'] . "', '" . $_POST['route_code'] . "', '" . $_POST['route_dl_cat'] . "','" . $_POST['day'] . "')";
        ...
        if ($num > 0)
        {
            ...
            $sql_dl = "INSERT INTO `dl_center` (prim, name, link, cat, date_t, des) VALUES ('$prim', '" . $_POST['route_code'] . "', '" . $_POST['route_card'] . "', '" . $_POST['route_dl_cat'] . "', '$date_db', '$na')";
